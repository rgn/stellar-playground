...
namespace Stellar.Common.Ui
{
    public abstract class MefBootstrapperBase : BootstrapperBase
    {
        private CompositionContainer container;

        public MefBootstrapperBase()
        {
            Initialize();
        }
        ...
        protected override void Configure()
        {
            ...
            var directoryCatalog = new DirectoryCatalog(".", "Stellar.Common.dll");
